...
import com.rb.sss.service.ServDemo108Service;
import com.rb.core.rest.ConfigIdentifier;
import com.rb.core.rest.GenericApi;

@Path("/api/v1/employees")
public class ServDemo108Controller {

    public static final Logger logger = LoggerFactory.getLogger(ServDemo108Controller.class);
	@Inject
	ServDemo108Service service;
